    ...
    internal static class Program
    {
        ...
        static IHostBuilder CreateHostBuilder()
        {
            return Host.CreateDefaultBuilder().ConfigureServices((context, services) =>
            {
                ...
                services.AddTransient<ITemplateLineHandler, CreateFieldsLineHandler>();
                services.AddTransient<ITemplateLineHandler, UpdateFieldsLineHandler>();
                ...
                services.AddTransient<ITemplateLineHandler, CreatePropertyConstructorLineHandler>();
                services.AddTransient<ITemplateLineHandler, ResponsePropertyConstructorLineHandler>();
                services.AddTransient<ITemplateLineHandler, UpdateCommandConstructorLineHandler>();
